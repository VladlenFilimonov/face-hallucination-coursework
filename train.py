...
import pytorch_ssim
from data_loader import TrainDatasetFromFolder, ValidationDatasetFromFolder, display_transform
...
if __name__ == '__main__':
    ...
    train_set = TrainDatasetFromFolder('data/debug/train')
    val_set = ValidationDatasetFromFolder('data/debug/valid')
            ...
            for val_lr, val_hr in val_bar:
                ...
                val_images.extend(
                    [display_transform()(hr.data.cpu().squeeze(0)),
                     ...
                     display_transform()(lr.data.cpu().squeeze(0)),
                     ])
